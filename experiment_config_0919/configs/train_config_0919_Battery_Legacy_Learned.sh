#!/usr/bin/env bash
# 0919 direct-dual excess-capacity / gate-pooling study. Standalone; no config inheritance.
...
# Prediction-head variant; production branch MLP width is 2 * hidden = 256.
HEAD_TYPE="dual"
GATE_MODE="window"
...
# Fixed existing direct-dual supervision: BODY=1, trajectory EXCESS=2, GATE=0.5.
BODY_LOSS_WEIGHT=1
EXCESS_LOSS_WEIGHT=2
GATE_LOSS_WEIGHT=0.5
TAIL_FRAC="0.05"
TAIL_LAMBDA_LIST=("0")
# Auxiliary tail and slope coefficients are zero; only MSE is selected.
SLOPE_LAMBDA_LIST=("0")
SLOPE_MASK_S_LIST=("0.10")
SLOPE_ROBUST="charb"
SLOPE_CHARB_EPS="1e-3"
SLOPE_HUBER_DELTA="0.05"
# Threshold infrastructure only; this study never selects a WMSE loss mode.
WMSE_Q_LIST=("95")
WMSE_ALPHA="4.0"
WMSE_S="0.10"
WMSE_USE_ABS=1
...
USE_TMUX=1
SESSION_NAME="${SESSION_NAME:-0919_Battery_Legacy_Learned}"
PACT_RUN_NAME="0919_Battery_Legacy_Learned"
ALL_RESULTS_ROOT="/home/exouser/media/volume/PACT-Data/StormSurge/All_results_0919"
...
EXCEEDANCE_HEAD_EXPERIMENT="legacy"
EXCEEDANCE_GATE_POOLING="learned"
