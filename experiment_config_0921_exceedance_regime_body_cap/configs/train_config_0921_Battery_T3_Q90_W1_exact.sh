#!/usr/bin/env bash
# 0921 TRAIN exceedance regime / body-cap study. Standalone; no config inheritance.
...
USE_TMUX=1
SESSION_NAME="${SESSION_NAME:-0921_Battery_T3_Q90_W1_exact}"
PACT_RUN_NAME="0921_Battery_T3_Q90_W1_exact"
ALL_RESULTS_ROOT="/media/share/PACT/Results/All_results_0921_exceedance_regime_body_cap"
