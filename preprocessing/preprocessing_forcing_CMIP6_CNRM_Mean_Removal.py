...
out_dir = "./Processed_Forcing_CMIP6_CNRM"
os.makedirs(out_dir, exist_ok=True)

cdf_file = "./CMIP6_CNRM/uas_3hr_CNRM-CM6-1_historical_r1i1p1f2_gr_197001010300-198001010000_lat0.0-55.0_lon-100.0--40.0_years1970-1980.nc"
...
np.savez(
    os.path.join(out_dir, "grid_local_cmip6_cnrm.npz"),
    lat_local=lat_local,
    lon_local=lon_local,
...
print("\nSaved local grid metadata to:", os.path.join(out_dir, "grid_local_cmip6_cnrm.npz"))
...
print("\nDone. Saved processed CMIP6_CNRM local forcing under:", out_dir)
