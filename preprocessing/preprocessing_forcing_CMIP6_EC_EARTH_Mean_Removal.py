...
# Paths
# ------------------------
base_dir = "./CMIP6_EC_EARTH"
forcing_dir = base_dir
out_dir = "./Processed_Forcing_CMIP6_EC_EARTH"
os.makedirs(out_dir, exist_ok=True)

cdf_file = "./CMIP6_EC_EARTH/uas_3hr_EC-Earth3_historical_r1i1p1f1_gr_197001010000-197012312100_lat0.0-55.0_lon-100.0--40.0_years1970-1970.nc"
...
np.savez(
    os.path.join(out_dir, "grid_local_cmip6_ec_earth.npz"),
    lat_local=lat_local,
    lon_local=lon_local,
...
print("\nSaved local grid metadata to:", os.path.join(out_dir, "grid_local_cmip6_ec_earth.npz"))
...
print("\nDone. Saved processed CMIP6_EC_EARTH local forcing under:", out_dir)
