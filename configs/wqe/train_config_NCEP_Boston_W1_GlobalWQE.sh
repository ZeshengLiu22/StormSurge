#!/usr/bin/env bash
# WQE placement experiment (existing D0 is the MSE/MSE control): Boston / W1.
...
PACT_RUN_NAME="NCEP_Boston_W1_GlobalWQE"
PYTHON_RUN_TAG_BASE="NCEP_Boston_W1_GlobalWQE"
