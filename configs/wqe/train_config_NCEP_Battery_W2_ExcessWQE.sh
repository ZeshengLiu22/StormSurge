#!/usr/bin/env bash
# WQE placement experiment (existing D0 is the MSE/MSE control): Battery / W2.
...
ALL_RESULTS_ROOT="/home/exouser/media/share/PACT/WQE_Results"
RUN_DIR_NAME_STYLE="runname_timestamp"
PACT_RUN_NAME="NCEP_Battery_W2_ExcessWQE"
PYTHON_RUN_TAG_BASE="NCEP_Battery_W2_ExcessWQE"
