#!/usr/bin/env bash
# WQE placement experiment (existing D0 is the MSE/MSE control): Battery / W1.
...
PACT_RUN_NAME="NCEP_Battery_W1_GlobalWQE"
PYTHON_RUN_TAG_BASE="NCEP_Battery_W1_GlobalWQE"
