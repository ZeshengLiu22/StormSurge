#!/usr/bin/env bash
# WQE placement experiment (existing D0 is the MSE/MSE control): Boston / W2.
...
PACT_RUN_NAME="NCEP_Boston_W2_ExcessWQE"
PYTHON_RUN_TAG_BASE="NCEP_Boston_W2_ExcessWQE"
