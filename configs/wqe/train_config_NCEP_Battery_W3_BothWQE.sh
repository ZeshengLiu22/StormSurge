#!/usr/bin/env bash
# WQE placement experiment (existing D0 is the MSE/MSE control): Battery / W3.
...
PACT_RUN_NAME="NCEP_Battery_W3_BothWQE"
PYTHON_RUN_TAG_BASE="NCEP_Battery_W3_BothWQE"
