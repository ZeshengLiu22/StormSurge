#!/usr/bin/env bash
# Matched WQE/Tail factorial (four VAL-only checkpoint roles): Battery / G1_E1_T1.
...
PACT_RUN_NAME="NCEP_Battery_G1_E1_T1"
PYTHON_RUN_TAG_BASE="NCEP_Battery_G1_E1_T1"
