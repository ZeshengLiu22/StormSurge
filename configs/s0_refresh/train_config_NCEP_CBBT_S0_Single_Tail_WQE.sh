#!/usr/bin/env bash
# Single-head S0_Tail_WQE comparison (four VAL-only checkpoint roles): CBBT.
...
PACT_RUN_NAME="NCEP_CBBT_S0_Single_Tail_WQE"
PYTHON_RUN_TAG_BASE="NCEP_CBBT_S0_Single_Tail_WQE"
