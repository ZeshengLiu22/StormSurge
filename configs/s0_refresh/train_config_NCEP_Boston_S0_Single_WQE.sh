#!/usr/bin/env bash
# Single-head WQE comparison (four VAL-only checkpoint roles): Boston / S0-WQE.
...
PACT_RUN_NAME="NCEP_Boston_S0_Single_WQE"
PYTHON_RUN_TAG_BASE="NCEP_Boston_S0_Single_WQE"
