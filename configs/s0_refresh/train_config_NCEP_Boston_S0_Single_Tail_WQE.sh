#!/usr/bin/env bash
# Single-head S0_Tail_WQE comparison (four VAL-only checkpoint roles): Boston.
...
PACT_RUN_NAME="NCEP_Boston_S0_Single_Tail_WQE"
PYTHON_RUN_TAG_BASE="NCEP_Boston_S0_Single_Tail_WQE"
