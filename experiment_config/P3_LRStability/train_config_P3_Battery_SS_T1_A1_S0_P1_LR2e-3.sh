...
USE_TMUX=1
SESSION_NAME="${SESSION_NAME:-P3_Battery_SS_T1_A1_S0_P1_LR2e-3}"
PACT_RUN_NAME="P3_Battery_SS_T1_A1_S0_P1_LR2e-3"
ALL_RESULTS_ROOT="./All_Results/P3_LRStability"
