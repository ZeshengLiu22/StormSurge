#!/usr/bin/env bash
# P1 weight probe; P0 training protocol. Fully independent; no runtime inheritance.
...
# Current supervised exceedance dual head, unchanged from P0.
HEAD_TYPE="dual"
GATE_MODE="window"
...
LOSS_MODE_LIST=("mse_tail")

# Probe excess/tail strength; body/gate stay frozen and slope is disabled.
BODY_LOSS_WEIGHT=1
EXCESS_LOSS_WEIGHT=10
GATE_LOSS_WEIGHT=0.5
TAIL_FRAC="0.05"
TAIL_LAMBDA_LIST=("0.05")
SLOPE_LAMBDA_LIST=("0")
SLOPE_MASK_S_LIST=("0.10")
SLOPE_ROBUST="charb"
SLOPE_CHARB_EPS="1e-3"
SLOPE_HUBER_DELTA="0.05"
# Threshold infrastructure only; P1 never selects a WMSE loss mode.
WMSE_Q_LIST=("95")
WMSE_ALPHA="4.0"
WMSE_S="0.10"
WMSE_USE_ABS=1
...
USE_TMUX=1
SESSION_NAME="${SESSION_NAME:-P1_Battery_dual_ex10_tail005}"
PACT_RUN_NAME="NCEP_Battery_24h_dual_ex10_tail005"
