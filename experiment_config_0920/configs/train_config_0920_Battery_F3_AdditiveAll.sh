#!/usr/bin/env bash
# 0920 direct-dual reconstruction / supervision-scope study. Standalone; no config inheritance.
...
USE_TMUX=1
SESSION_NAME="${SESSION_NAME:-0920_Battery_F3_AdditiveAll}"
PACT_RUN_NAME="0920_Battery_F3_AdditiveAll"
