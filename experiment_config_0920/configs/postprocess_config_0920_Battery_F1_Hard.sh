...
FORMULATION="F1_Hard"
STATION="Battery"
PACT_RUN_NAME="0920_Battery_F1_Hard"
SOURCE_RUN_NAME="0920_Battery_F0_Soft"
SOURCE_CONFIG="experiment_config_0920/configs/train_config_0920_Battery_F0_Soft.sh"
SOURCE_CHECKPOINT="/home/exouser/media/volume/PACT-Data/StormSurge/All_results_0920/0920_Battery_F0_Soft__<TIMESTAMP>/best_*.pth"
