...
<!-- choices loss_mode: mse,wmse,mse_slope,wmse_slope -->
...
Both prediction objectives have units m², apply to every target hour, and support Single, Direct Dual, and Severity–Shape Dual. Their direct paths reach the Single regression head or the Dual body, excess, and learned gate. For Severity–Shape, the excess path reaches severity and shape.
