#!/usr/bin/env bash
# LR-only copy of the frozen factorial: Lewes / D3. Exactly one run.
...
ALL_RESULTS_ROOT="/media/share/PACT/Results/All_results_0921_lr3e3"
RUN_DIR_NAME_STYLE="runname_timestamp"
PACT_RUN_NAME="0921_Lewes_D3_TailAmp_LR3e3"
PYTHON_RUN_TAG_BASE="0921_Lewes_D3_TailAmp_LR3e3"
