#!/usr/bin/env bash
# LR-only copy of the frozen factorial: Lewes / D0. Exactly one run.
...
PACT_RUN_NAME="0921_Lewes_D0_DualBase_LR3e3"
PYTHON_RUN_TAG_BASE="0921_Lewes_D0_DualBase_LR3e3"
