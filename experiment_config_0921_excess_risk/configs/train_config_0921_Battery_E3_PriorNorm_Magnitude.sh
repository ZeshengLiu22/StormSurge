#!/usr/bin/env bash
# 0921 excess-risk aggregation study. Standalone; no config inheritance.
...
USE_TMUX=1
SESSION_NAME="${SESSION_NAME:-0921_Battery_E3_PriorNorm_Magnitude}"
PACT_RUN_NAME="0921_Battery_E3_PriorNorm_Magnitude"
ALL_RESULTS_ROOT="/media/share/PACT/Results/All_results_0921_excess_risk"
