#!/usr/bin/env bash
# A0 prediction-head / excess-branch capacity study. Standalone; no config inheritance.
...
# Matched direct/severity supervision: BODY=1, trajectory EXCESS=2, GATE=0.5.
BODY_LOSS_WEIGHT=1
...
USE_TMUX=1
SESSION_NAME="${SESSION_NAME:-A0_Battery_dual_severity_base}"
PACT_RUN_NAME="NCEP_Battery_24h_dual_severity_base"
ALL_RESULTS_ROOT="./All_results_0916/A0_HeadCapacity"
RUN_DIR_NAME_STYLE="runname_timestamp"
PYTHON_RUN_TAG_BASE="${PACT_RUN_NAME}"

# All peak-aware auxiliary losses are OFF, including for severity_shape.
