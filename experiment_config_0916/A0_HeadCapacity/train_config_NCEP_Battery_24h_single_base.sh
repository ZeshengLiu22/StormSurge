...
# Pure prediction MSE: dual supervision is disabled; branch weights are explicitly zero.
BODY_LOSS_WEIGHT=0
...
USE_TMUX=1
SESSION_NAME="${SESSION_NAME:-A0_Battery_single_base}"
PACT_RUN_NAME="NCEP_Battery_24h_single_base"
